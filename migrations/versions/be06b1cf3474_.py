...
Revision ID: be06b1cf3474
Revises: 
Create Date: 2021-06-28 15:29:15.475361
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('command_id', sa.INTEGER(), autoincrement=False, nullable=True, comment='Command id'),
    sa.Column('device_group_id', sa.INTEGER(), autoincrement=False, nullable=True, comment='Device group id'),
    sa.Column('device_id', sa.INTEGER(), autoincrement=False, nullable=True, comment='Device id'),
    sa.Column('status_id', sa.INTEGER(), autoincrement=False, nullable=False, comment='Command status'),
    sa.Column('status_changed_time', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=True, comment='Create time'),
    sa.ForeignKeyConstraint(['command_id'], ['sd60_command.id'], name='sd61_command_device_command_id_fkey'),
    sa.ForeignKeyConstraint(['device_group_id'], ['sd22_device_groups.id'], name='sd61_command_device_device_group_id_fkey'),
    sa.ForeignKeyConstraint(['device_id'], ['sd21_devices.id'], name='sd61_command_device_device_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='sd61_command_device_pkey')
    )
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('action', sa.INTEGER(), autoincrement=False, nullable=False, comment='Command action, 0 = dimming, 1 = power on/off'),
    sa.Column('value', sa.VARCHAR(length=5), autoincrement=False, nullable=False, comment='Command value, dimming = 0~100, power = 0/1 (off/on), schedule = incre (y/n)'),
    sa.Column('create_time', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=True, comment='Create time'),
    sa.Column('schedule_value', sa.VARCHAR(length=200), autoincrement=False, nullable=True, comment='Save schedule value in json type'),
    sa.Column('cust_id', sa.INTEGER(), autoincrement=False, nullable=True, comment='Customer id'),
    sa.ForeignKeyConstraint(['cust_id'], ['sd10_customers.id'], name='sd60_command_cust_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='sd60_command_pkey')
    )
