...
def upgrade():
    ...
    op.create_table('sd00_blacklist_tokens',
                    ...
                    sa.Column('create_time', sa.DateTime(), server_default=sa.text(
                        'now()'), nullable=False, comment='Create time'),
    ...
    op.create_table('sd10_customers',
                    ...
                    sa.Column('create_time', sa.DateTime(), server_default=sa.text(
                        'now()'), nullable=False, comment='Create time'),
                    sa.Column('update_time', sa.DateTime(), server_default=sa.text(
                        'now()'), nullable=False, comment='Update time'),
                    sa.Column('cust_id', sa.Integer(), nullable=True, comment='Vendor of customer'),
                    sa.Column('issue_namespace', sa.String(
                        length=50), server_default='CUSTOM-{datetime:%Y%m%d}-{serial_no:05d}', nullable=False, comment='Issue number namespace'),
    ...
    op.create_table('sd30_device_models',
                    ...
                    sa.Column('display_name', sa.String(length=50), nullable=True,
                              comment='Part description + specification'),
                    sa.Column('comment', sa.Text(), nullable=True, comment='Comment'),
                    sa.Column('create_time', sa.DateTime(), server_default=sa.text(
                        'now()'), nullable=True, comment='Create time'),
                    sa.Column('update_time', sa.DateTime(), server_default=sa.text(
                        'now()'), nullable=True, comment='Update time'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('sd12_codes',
                    ...
                    sa.Column('code_type', sa.Integer(), nullable=True,
                              comment='Code type, specification write in constant'),
    ...
    op.create_table('sd31_controllers',
                    ...
                    sa.Column('model_id', sa.Integer(), server_default='0',
                              nullable=True, comment='AcBel model/part no'),
    ...
    op.create_table('sd41_schedule_groups',
                    ...
                    sa.Column('update_time', sa.DateTime(), server_default=sa.text(
                        'now()'), nullable=True, comment='Update time'),
                    sa.Column('scheme', sa.String(length=4), nullable=True,
                              comment='Schedule Time Scheme, 24h and srss'),
                    sa.Column('incre', sa.String(length=1), nullable=True, comment='Increase Light, y/n'),
                    sa.Column('cust_id', sa.Integer(), nullable=True, comment='Customer id'),
                    sa.ForeignKeyConstraint(['cust_id'], ['sd10_customers.id'], ),
                    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('sd60_command',
                    ...
                    sa.Column('action', sa.Integer(), nullable=False,
                              comment='Command action, 0 = dimming, 1 = power on/off'),
                    ...
                    sa.Column('schedule_value', sa.String(length=200), nullable=True,
                              comment='Save schedule value in json type'),
                    sa.Column('cust_id', sa.Integer(), nullable=True, comment='Customer id'),
                    sa.ForeignKeyConstraint(['cust_id'], ['sd10_customers.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('sd21_devices',
                    ...
                    sa.Column('update_time', sa.DateTime(), server_default=sa.text(
                        'now()'), nullable=True, comment='Update time'),
                    sa.Column('dev_type', sa.Integer(), server_default='0', nullable=True,
                    ...
                    sa.Column('power_status', sa.Integer(), nullable=True,
                              comment='Device power status. null: unknown, 0: off, 1: on'),
                    sa.Column('device_group_id', sa.Integer(), nullable=True,
    ...
    op.create_table('sd53_event_logs',
                    ...
                    sa.Column('update_time', sa.DateTime(), server_default=sa.text(
                        'now()'), nullable=True, comment='Update time'),
                    sa.Column('data_time', sa.DateTime(), server_default=sa.text(
                        'now()'), nullable=True, comment='device data time'),
    ...
    op.create_table('sd61_command_device',
                    ...
                    sa.Column('status_changed_time', sa.DateTime(), server_default=sa.text(
                        'now()'), nullable=True, comment='Create time'),
